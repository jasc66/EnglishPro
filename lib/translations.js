const t = {
  es: {
    ...
    about: {
      ...
      desc: 'Nacido en Costa Rica con raíces francesas, alemanas e inglesas, Jean Pierre creció inmerso en el idioma inglés desde su primera infancia. Durante más de 25 años trabajó en el sector financiero gestionando inversiones de empresas extranjeras en el país — lo que significa que no solo domina el inglés, sino que entiende de primera mano cómo piensan, negocian y se comunican los extranjeros en el mundo real de los negocios. Hoy aplica toda esa experiencia para enseñarte el inglés que realmente necesitas: directo, profesional y enfocado en resultados.',
      credentials: [
        'Hablante nativo de inglés con raíces francesa, alemana e inglesa',
        '25+ años en finanzas e inversiones con empresas extranjeras',
        'Amplia experiencia negociando con ejecutivos internacionales',
        'Conocimiento profundo de bienes raíces, turismo y relocation',
        'Enfoque 100% orientado a resultados y al mundo de los negocios',
      ],
  ...
  en: {
    ...
    about: {
      ...
      desc: 'Born in Costa Rica with French, German and English roots, Jean Pierre grew up immersed in the English language from an early age. For over 25 years he worked in finance, managing investments from foreign companies operating in Costa Rica — meaning he doesn\'t just speak English fluently, he truly understands how foreigners think, negotiate and communicate in the real business world. Today he brings all that experience to help you learn the English you actually need: direct, professional and focused on results.',
      credentials: [
        'Native English speaker with French, German & English roots',
        '25+ years in finance & investment with foreign companies',
        'Extensive experience negotiating with international executives',
        'Deep knowledge of real estate, tourism & relocation',
        '100% results-oriented, business-focused approach',
      ],
