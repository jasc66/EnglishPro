const t = {
  es: {
    ...
    about: {
      ...
      title: ['Jean Pierre Schmidt Calvo,', 'costarricense, trilingüe y orientado a resultados'],
      desc: 'Nacido en Costa Rica con raíces francesas, alemanas e inglesas, Jean Pierre creció usando el inglés como idioma de vida, no de estudio. Su trayectoria profesional lo llevó por dos mundos muy distintos pero complementarios: más de 25 años en finanzas gestionando inversiones de empresas extranjeras, y una etapa intensa en turismo trabajando directamente con turistas de habla inglesa. A lo largo de su carrera construyó relaciones con profesionales de múltiples sectores, tanto dentro de Costa Rica como en el extranjero. Esa combinación única — finanzas, turismo y una red internacional — le da una perspectiva real de cómo el inglés funciona en cada contexto profesional. No enseña un inglés de libro: enseña el inglés que él mismo usó para cerrar negocios, atender clientes y conectar con personas de todo el mundo.',
      credentials: [
        'Hablante nativo con raíces francesa, alemana e inglesa',
        '25+ años en finanzas e inversiones con empresas extranjeras',
        'Experiencia directa en turismo con visitantes de habla inglesa',
        'Red de contactos profesionales en múltiples sectores y países',
        'Enfoque práctico basado en negocios y resultados reales',
      ],
      badge: '⭐ 4.9 / 5.0 · 500+ alumnos',
      floating1: '🌍 Nativo de inglés',
      floating2: '💼 25+ años en negocios',
  ...
  en: {
    ...
    about: {
      ...
      title: ['Jean Pierre Schmidt Calvo,', 'Costa Rican, trilingual & results-driven'],
      desc: 'Born in Costa Rica with French, German and English roots, Jean Pierre grew up using English as a language of life, not a subject in school. His career took him through two very different but complementary worlds: over 25 years in finance managing investments for foreign companies, and a rich period in tourism working directly with English-speaking visitors. Along the way he built relationships with professionals across many industries, both inside Costa Rica and abroad. That unique combination — finance, tourism and an international network — gives him a genuine understanding of how English works in every professional context. He doesn\'t teach textbook English: he teaches the English he actually used to close deals, serve clients and connect with people from around the world.',
      credentials: [
        'Native English speaker with French, German & English roots',
        '25+ years in finance & investment with foreign companies',
        'Hands-on experience in tourism with English-speaking visitors',
        'Professional network across multiple sectors and countries',
        'Practical approach grounded in real business and results',
      ],
      badge: '⭐ 4.9 / 5.0 · 500+ students',
      floating1: '🌍 Native speaker',
      floating2: '💼 25+ yrs in business',
