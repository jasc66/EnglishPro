  ...
  es: {
    ...
    hero: {
      ...
      stats: [
        ...
        { num: '16', label: 'Sectores especializados' },
    ...
    about: {
      ...
      credentials: [
        ...
        'Especialización en 16 sectores profesionales',
  ...
  en: {
    ...
    hero: {
      ...
      stats: [
        ...
        { num: '16', label: 'Specialized sectors' },
    ...
    about: {
      ...
      credentials: [
        ...
        'Specialization in 16 professional sectors',
